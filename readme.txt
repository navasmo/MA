...
Notes:
1 - Please ensure that you delete the previously created myBooks.db database.
2 - Use "Ctrl + C" to terminate a previously created terminal node and npm processes. 
